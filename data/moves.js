...
let BattleMovedex = {
	...
	"dreameater": {
		...
		basePower: 180,
		category: "Special",
		desc: "The target is unaffected by this move unless it is asleep or poisoned. The user recovers 1/2 the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3x normal, rounded half down.",
		shortDesc: "User gains 1/2 HP inflicted. Sleeping or poisoned target only.",
		id: "dreameater",
		name: "Dream Eater",
		pp: 15,
		priority: 0,
	...
	"hyperfang": {
		...
		basePower: 150,
		category: "Special",
		desc: "Drops Special two stages.",
		shortDesc: "Drops Special two stages.",
		id: "hyperfang",
		name: "Hyper Fang",
		pp: 15,
		priority: 0,
	...
	"megadrain": {
		...
		basePower: 40,
		category: "Special",
		desc: "The user recovers all the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3x normal, rounded half down.",
		shortDesc: "User recovers 100% of the damage dealt.",
		id: "megadrain",
		name: "Mega Drain",
		pp: 15,
