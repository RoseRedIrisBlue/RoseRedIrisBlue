...
getAbilitiesFor=function getAbilitiesFor(id,gen){
...
divHTML='<small>'+BattleLog.escapeHTML(_user.name)+' left.</small>';
break;
}
case'name':case'n':{
var _user2=BattleTextParser.parseNameParts(args[1]);
if(toID(args[2])!==toID(_user2.name)){
divHTML='<small>'+BattleLog.escapeHTML(_user2.name)+' renamed from '+BattleLog.escapeHTML(args[2])+'.</small>';
}
break;
}
case'chatmsg':case'':
